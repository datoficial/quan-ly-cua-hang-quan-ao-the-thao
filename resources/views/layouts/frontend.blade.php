				...
				<div class="navbar navbar-expand-lg navbar-light">
					<div class="container">
						...
						<a class="navbar-brand d-sm-none flex-shrink-0 me-2" href="{{ route('frontend.home') }}">
							<img src="{{ asset('public/img/logo-icon1.png') }}" width="74" />
						</a>
							...
							<ul class="navbar-nav">
								<li class="nav-item dropdown">
									...
									<ul class="dropdown-menu">
										<li><a class="dropdown-item" href="{{ route('frontend.sanpham.phanloai', ['tenloai_slug' => 'quan-ao-bong-da']) }}">Quần áo bóng đá</a></li>
										<li><a class="dropdown-item" href="{{ route('frontend.sanpham.phanloai', ['tenloai_slug' => 'gang-tay']) }}">Găng tay</a></li>
										<li><a class="dropdown-item" href="{{ route('frontend.sanpham.phanloai', ['tenloai_slug' => 'quan-short']) }}">Quần short</a></li>
										<li><a class="dropdown-item" href="{{ route('frontend.sanpham.phanloai', ['tenloai_slug' => 'bong-da'])  }}">Bóng đá</a></li>
										<li><a class="dropdown-item" href="{{ route('frontend.sanpham.phanloai', ['tenloai_slug' => 'giay-bong-da']) }}">Giày bóng đá</a></li>
									</ul>
								</li>
								<li class="nav-item">
				...
				<div class="row pb-2">
					<div class="col-md-6 text-center text-md-start mb-4">
						<div class="text-nowrap mb-4">
							<a class="d-inline-block align-middle mt-n1 me-3" href="#"><img class="d-block" src="{{ asset('public/img/footer-logo-light1.png') }}" width="200" /></a>
						</div>
					...
					<div class="col-md-6 text-center text-md-end mb-4">
						<div class="mb-3">
							...
							<a class="btn-social bs-light bs-tiktok ms-2 mb-2" href="#"><i class="ci-tiktok"></i></a>
						</div>
					</div>
				</div>
				<div class="pb-4 fs-xs text-light opacity-50 text-center text-md-start">Bản quyền © 2023 bởi K-Sport.</div>
			</div>
		</div>
	</footer>
