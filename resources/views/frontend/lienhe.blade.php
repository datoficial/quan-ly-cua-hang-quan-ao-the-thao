						...
						<div class="card-body text-center">
							...
							<ul class="list-unstyled fs-sm mb-0">
								<li>
									...
									<a class="nav-link-style" href="tel:+84123456888">+84 0382947244</a>
								</li>
								<li class="mb-0">
									<span class="text-muted me-1">Hỗ trợ kỹ thuật:</span>
									<a class="nav-link-style" href="tel:+84123456999">+84 0867064672</a>
								</li>
							</ul>
						</div>
					</div>
					...
					<div class="card h-100">
						<div class="card-body text-center">
							...
							<ul class="list-unstyled fs-sm mb-0">
								<li>
									<span class="text-muted me-1">Bán hàng:</span>
									<a class="nav-link-style" href="mailto:customer@larashop.vn">npdat@ksport.vn</a>
								</li>
								<li class="mb-0">
									<span class="text-muted me-1">Hỗ trợ kỹ thuật:</span>
									<a class="nav-link-style" href="mailto:support@larashop.vn">support@ksport.vn</a>
								</li>
							</ul>
						</div>
					</div>
